...
```
<img src="ссылка на картинку" alt="альтернативный текст" width="250" height="250">
``` 

* С дефолтными параметрами высоты и ширины

```
![DATA](/pictures/other/git_data.png)
```
...
[1.2 Git Folder](/1%20Common/1.2%20Git/) | [Back To iTWiki Contents](https://github.com/eldaroid/iTWiki) |  [1.2.1.2 Marmaid Diagram Theme](./1.2.1.2%20MermaidDiagram.md)
