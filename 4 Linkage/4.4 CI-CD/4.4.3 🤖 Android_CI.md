...
![CI_stages_Android](https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/CI_stages_Android.jpg?raw=true)
...
![ГрадлПропертисТребуютАвторизации.png](https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/ГрадлПропертисТребуютАвторизации.png?raw=true)

<img src="https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/ГрадлПропертисТребуютАвторизации.png?raw=true" alt="ГрадлПропертисТребуютАвторизации.png" width="600" height="320">
...
<img src="https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/БесконечнаяЗагрузка.png?raw=true" alt="БесконечнаяЗагрузка.png" width="600" height="60">
...
<img src="https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/metro.png?raw=true" alt="metro.png" width="280" height="600">
