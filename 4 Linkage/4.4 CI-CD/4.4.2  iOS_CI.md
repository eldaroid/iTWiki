...
![CI_stages_iOS](https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/CI_stages_iOS.jpg?raw=true)
...
> ![](https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/sonar-scenner.png?raw=true)
...
4. Выбрать таргет `YourAppBeta` и устройство для сборки any iOS device: ![](https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/formBeta.png?raw=true)
...
iTWiki/Frameworks/formInhouse.png

1. Войти в работающую сборочную машину (н/р: mac-mini-1)
2. Открыть директорию с репой `~/jenkins/workspace/YourApp/CI123123/ios`
3. Запустить `./generate_all.sh -o`
4. Выбрать таргет `YourApp` и устройство для сборки any iOS device: ![](https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/formInhouse2.png?raw=true)
...
![ErrorJnlpAgentEndpointResolver](https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/ErrorJnlpAgentEndpointResolver2.png?raw=true)
