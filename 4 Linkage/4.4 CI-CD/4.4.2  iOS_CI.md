...
#### Структура Xcode проектов:

* **Workspace** - сущность из набора проектов (обычно один проект)
* **Project** - "грубо" набор файлов с кодом и прочего (например иконки)
* **Target** - набор билд настроек и файлов/классов/либ проекта (например
* **Scheme** - описание экшенов (сборка, тест, архив) таргета (обычно 1 схема для 1 таргета)
