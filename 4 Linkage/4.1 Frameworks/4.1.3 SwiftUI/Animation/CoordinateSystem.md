...
![](https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/SwiftUI/CoordinateSystemInSchool.jpeg?raw=true)

Apple предлагает разработчикам пользоваться перевернутой (а точнее отраженной) системой координат:

![](https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/SwiftUI/CoordinateSystemIphone.jpeg?raw=true)
...
![](https://github.com/eldaroid/pictures/blob/master/iTWiki/Frameworks/SwiftUI/Angels.jpeg?raw=true)
