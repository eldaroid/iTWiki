...
![FrameVsBounds1](/pictures/Frameworks/UIKit/FrameVSBounds.jpeg?raw=true)
...
![FrameVsBounds2](/pictures/Frameworks/UIKit/FrameVSBoundsOffset.jpeg?raw=true)
...
![FrameVsBounds3](/pictures/Frameworks/UIKit/SetOriginFrameAndBounds.gif?raw=true)

### Что произойдет, если вы преобразуете вид, используя 20 градусов по часовой стрелке?

![FrameVsBounds4](/pictures/Frameworks/UIKit/FrameVSBoundsRotation.jpeg?raw=true)
